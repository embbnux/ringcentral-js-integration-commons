...
var DataFetcher = (_class = function (_Pollable) {
  ...
  (0, _createClass3.default)(DataFetcher, [{
    ...
    value: function _shouldInit() {
      return this._auth.loggedIn && (!this._storage || this._storage.ready) && (!this._readyCheckFn || this._readyCheckFn()) && (!this._subscription || this._subscription.ready) && this.pending;
    }
  }, {
    key: '_shouldReset',
    value: function _shouldReset() {
      return (!this._auth.loggedIn || !!this._storage && !this._storage.ready || !!this._readyCheckFn && !this._readyCheckFn() || !!this._subscription && !this._subscription.ready) && this.ready;
    }
  }, {
