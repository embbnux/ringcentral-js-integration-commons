...
var ConversationLogger = function (_LoggerBase) {
  ...
  function ConversationLogger(_ref2) {
    var contactMatcher = _ref2.contactMatcher,
      ...
      return dateTimeFormat.formatDateTime.apply(dateTimeFormat, arguments);
        ...
        options = (0, _objectWithoutProperties3.default)(_ref2, ['contactMatcher', 'conversationMatcher', 'isLoggedContact', 'extensionInfo', 'messageStore', 'dateTimeFormat', 'formatDateTime', 'storage', 'tabManager']);
  ...
  (0, _createClass3.default)(ConversationLogger, [{
    ...
    value: function _shouldInit() {
      return this.pending && this._messageStore.ready && this._contactMatcher.ready && this._conversationMatcher.ready && this._dateTimeFormat.ready && this._extensionInfo.ready && this._storage.ready && this._tabManager.ready && this._readyCheckFunction();
    }
  }, {
    key: '_shouldReset',
    value: function _shouldReset() {
      return this.ready && (!this._messageStore.ready || !this._contactMatcher.ready || !this._conversationMatcher.ready || !this._dateTimeFormat.ready || !this._extensionInfo.ready || !this._storage.ready || !this._tabManager.ready || !this._readyCheckFunction());
    }
  }, {
    key: '_onReset',
